...
void MplayerEngine::play(Glib::RefPtr<Gdk::Window> window, const Glib::ustring& mrl)
{
	...
	parameters.add("-wid");
	parameters.add(GDK_WINDOW_XID(window->gobj()));
	parameters.add(mrl);
...
void MplayerEngine::record(const Glib::ustring& filename)
{
