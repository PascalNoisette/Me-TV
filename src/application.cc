...
void Application::make_directory_with_parents(Glib::ustring const & path) {
...
void Application::start_recording(Channel & channel, ScheduledRecording const & scheduled_recording) {
